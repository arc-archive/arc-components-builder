...
class BowerBuilder {
  ...
  /**
   * Prepares a list of ARC compnents for bower dependencies list.
   * It adds `advanced-rest-client/` prefix if missing for a name.
   *
   * @return {Object} Bower `dependencies` map from arc components.
   */
  ...
  /**
   * Prepares a list of web compnents for bower dependencies list.
   *
   * @return {Object} Bower `dependencies` map from web components.
   */
